...
#input files:
data_file = "../data/ImmGenATAC1219.peak.filteredSM0.05.bed"
intensity_file = '../data/ATAC_Data_Intensity_FilteredPeaksLogQuantile.txt'
reference_genome = "../data/chr_dict.pickle/"
